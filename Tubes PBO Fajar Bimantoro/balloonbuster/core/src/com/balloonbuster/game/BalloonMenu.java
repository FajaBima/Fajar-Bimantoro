...
public class BalloonMenu extends BaseScreen {
    ...
    protected void create() {
        bg = ActorManger.createActor(mainStage, "22.png", viewWidth / 2, viewHeight / 2);
        title = ActorManger.createActor(mainStage, "B.png", viewWidth / 2, viewHeight / 2);

        BitmapFont font = new BitmapFont();
        LabelStyle style = new LabelStyle(font, Color.NAVY);

        text = new Label("Play game ", style);
